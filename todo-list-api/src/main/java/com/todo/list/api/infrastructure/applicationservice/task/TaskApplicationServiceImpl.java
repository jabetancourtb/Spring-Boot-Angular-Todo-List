...
public class TaskApplicationServiceImpl implements TaskApplicationService{
	...
	public boolean create(TaskDTO taskDto) {
		return taskRepository.create(new Task(taskDto.getId(), taskDto.getTitle(), taskDto.getDescription(), taskDto.getUserId()));
	}

	@Override
	public boolean update(TaskDTO taskDto) {
		return taskRepository.update(new Task(taskDto.getId(), taskDto.getTitle(), taskDto.getDescription(), taskDto.getUserId()));
	}
	...
	public ResponseObject<Task> getByFilterAndUserId(final TaskDTO taskDto, final long limit, final long itemsToSkip) {
		Task task = new Task(taskDto.getId(), taskDto.getTitle(), taskDto.getDescription(), taskDto.getUserId());
