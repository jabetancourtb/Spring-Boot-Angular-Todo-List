...
public class UpdateUserPasswordRecoveryCommand implements Command<UserPasswordRecovery> {

    UserPasswordRecoveryService userPasswordRecoveryService;

    @Autowired
    public UpdateUserPasswordRecoveryCommand(UserPasswordRecoveryService userPasswordRecoveryService) {
    ...
    public UserPasswordRecovery execute(Params params) throws Exception {
        ...
        return userPasswordRecoveryService.updateUserPasswordRecovery(paramsImpl.userPasswordRecoveryDTO);
    }
}
